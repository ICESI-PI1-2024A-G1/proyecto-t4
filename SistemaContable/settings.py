...
DATABASES = {
   'default': dj_database_url.parse('postgres://testdb_mpgb_user:7F1sTyUK5S3nGBIc2t1evUsoMYKjTklo@dpg-conepp8cmk4c73a3v7kg-a.oregon-postgres.render.com/testdb_mpgb')
}
